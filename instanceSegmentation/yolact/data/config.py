...
cig_butts_dataset = dataset_base.copy({
  ...
  'train_info': 'CigButts_Dataset/train/coco_annotations.json',
  'train_images': 'CigButts_Dataset/train/images/',
  'valid_info': 'CigButts_Dataset/val/coco_annotations.json',
  'valid_images': 'CigButts_Dataset/val/images/',
  'class_names': ('cig_butt'),
  'label_map': { 1:  1 }
})

scissors_dataset= dataset_base.copy({
    'name': 'Test Scissors',
...
yolact_resnet50_scissors_config = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_scissors',
    # Dataset stuff
    'dataset': scissors_dataset,
    'num_classes': len(scissors_dataset.class_names) + 1,
